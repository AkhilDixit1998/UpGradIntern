...
class QuestionsRepository {
    ...
    QuestionsRepository(Application application) {
        ...
        QuDB questionsDatabase = QuDB.getInstance(context);
        quPOJO = questionsDatabase.questionsDao();
    }

    void insert(Question question) {
        Executors.newSingleThreadExecutor().execute(() -> {
            quPOJO.insert(question);
        });
    }
    ...
    private void fetchOfflineQuestions() {
        ...
        offlineLiveData = quPOJO.getOfflineQuestions();
